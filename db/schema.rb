...
ActiveRecord::Schema[7.1].define(version: 2024_06_06_151614) do
  ...
  create_table "activities", force: :cascade do |t|
    ...
    t.integer "duration"
    t.integer "exertion", default: 0, null: false
  ...
  create_table "runs", force: :cascade do |t|
    ...
    t.decimal "distance", precision: 16, scale: 8
    t.integer "elevation"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "distance_display_unit"
    t.string "elevation_display_unit"
  end
